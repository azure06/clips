...
export declare type RxDBAdapter = ['idb', unknown, 'idb', 'clips'] | ['leveldb', unknown, unknown, string];
export declare function initPlugins(rxDbAdapter: RxDBAdapter): RxDBAdapter;
